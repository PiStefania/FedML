...
if __name__ == '__main__':
    ...
    # my ref: only with accepted loans
    # --- epoch: 99, batch: 221, loss: 0.2642334058880806, acc: 0.933508665452829, auc: 0.4733933451621114
    # --- (0.4667543327264145, 0.5, 0.4828055245535714, None)
