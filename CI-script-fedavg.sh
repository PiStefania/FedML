...
## shakespeare (LEAF)
#sh run_fedavg_standalone_pytorch.sh 0 2 2 4 shakespeare ./../../../data/shakespeare rnn hetero 1 1 0.8 sgd 0 > ./logs/fedavg_standalone_shakespeare_logs.txt 2>&1
...
# Stackoverflow_LR
#sh run_fedavg_standalone_pytorch.sh 0 2 2 4 stackoverflow_lr ./../../../data/stackoverflow/datasets lr hetero 1 1 0.03 sgd 0 > ./logs/fedavg_standalone_stackoverflow_lr_logs.txt 2>&1
